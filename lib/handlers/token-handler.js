...
TokenHandler.prototype.handleGrantType = function(request, client) {
  ...
  var fns = [
    this.getAccessTokenLifetime(client, grantType),
    this.getRefreshTokenLifetime(client, grantType)
  ];
...
TokenHandler.prototype.getAccessTokenLifetime = function (client, grantType) {
  if (!this.model.getAccessTokenLifetime) {
    return this.accessTokenLifetime;
  }

  return Promise.try(this.model.getAccessTokenLifetime, [client, grantType], this.model)
...
TokenHandler.prototype.getRefreshTokenLifetime = function (client, grantType) {
  if (!this.model.getRefreshTokenLifetime) {
    return this.refreshTokenLifetime;
  }

  return Promise.try(this.model.getRefreshTokenLifetime, [client, grantType], this.model)
    .then(function (lifetime) {
      if (lifetime === null || lifetime > 0) {
        return lifetime;
      }
