...
AuthenticateHandler.prototype.getAccessToken = function(request, token) {
  return Promise.try(this.model.getAccessToken, [token, { request }], this.model)
...
AuthenticateHandler.prototype.validateScope = function(request, accessToken) {
  return Promise.try(this.model.validateScope, [accessToken, this.scope, { request }], this.model).then(function(scope) {
    if (!scope) {
